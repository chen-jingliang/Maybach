...
async function handleXHTTP(req, proxyPool) {
    ...
    const trans = typeof IdentityTransformStream === "function" ? new IdentityTransformStream(void 0, { highWaterMark: 1048576 }) : new TransformStream();
    const stReader = (() => {
